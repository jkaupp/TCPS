...
files <- dir(params$path, pattern = "sav", full.names = TRUE)
...
data %>%
  lever_ridgeline(name = params$name, pal = pal_one, aggregate = TRUE)
...
data %>%
  lever_ridgeline(name = params$name, pal = pal_one, aggregate = FALSE)
...
data %>%
  lever_scale("lever1", name = params$name)
```
...
data %>%
  lever_scale("lever2", name = params$name)
```
...
data %>%
  lever_scale("lever3", name = params$name)
```
...
data %>%
  lever_scale("lever4", name = params$name)
```
...
data %>%
  lever_scale("lever5", name = params$name)
```
...
data %>%
  lever_scale("lever6", name = params$name)
```
