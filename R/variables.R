...
#' A tibble containing the structure of each TCPS survey.
#' @export
tcps_structure <- structure(list(survey = c("Faculty", "Faculty", "Faculty", "Faculty",
                          "Faculty", "Faculty", "Faculty", "Faculty", "Faculty", "Faculty",
                          "Faculty", "Faculty", "Faculty", "Faculty", "Faculty", "Faculty",
                          "Faculty", "Faculty", "Faculty", "Faculty", "Faculty", "Faculty",
                          "Faculty", "Faculty", "Faculty", "Faculty", "Faculty", "Faculty",
                          "Faculty", "Faculty", "Faculty", "Faculty", "Faculty", "Faculty",
                          "Faculty", "Faculty", "Faculty", "Staff", "Staff", "Staff", "Staff",
                          "Staff", "Staff", "Staff", "Staff", "Staff", "Staff", "Staff",
                          "Staff", "Staff", "Staff", "Staff", "Staff", "Staff", "Staff",
                          "Staff", "Staff", "Staff", "Staff", "Staff", "Staff", "Staff",
                          "Staff", "Staff", "Staff", "Staff", "Staff", "Staff", "Staff",
                          "Staff", "Student", "Student", "Student", "Student", "Student",
                          "Student", "Student", "Student", "Student", "Student", "Student",
                          "Student", "Student", "Student", "Student", "Student", "Student",
                          "Student", "Student", "Student", "Student", "Student", "Student",
                          "Student", "Student", "Student", "Student", "Student", "Student",
                          "Student", "Student"), lever = c("lever1", "lever1", "lever1",
                                                           "lever1", "lever1", "lever1", "lever2", "lever2", "lever2", "lever2",
                                                           "lever2", "lever2", "lever3", "lever3", "lever3", "lever3", "lever3",
                                                           "lever3", "lever3", "lever4", "lever4", "lever4", "lever4", "lever4",
                                                           "lever5", "lever5", "lever5", "lever5", "lever5", "lever5", "lever5",
                                                           "lever6", "lever6", "lever6", "lever6", "lever6", "lever6", "lever1",
                                                           "lever1", "lever1", "lever1", "lever1", "lever1", "lever2", "lever2",
                                                           "lever2", "lever2", "lever3", "lever3", "lever3", "lever3", "lever3",
                                                           "lever3", "lever4", "lever4", "lever4", "lever4", "lever4", "lever4",
                                                           "lever5", "lever5", "lever5", "lever5", "lever5", "lever5", "lever6",
                                                           "lever6", "lever6", "lever6", "lever6", "lever1", "lever1", "lever1",
                                                           "lever1", "lever1", "lever2", "lever2", "lever2", "lever2", "lever2",
                                                           "lever3", "lever3", "lever3", "lever3", "lever3", "lever3", "lever4",
                                                           "lever4", "lever4", "lever4", "lever4", "lever5", "lever5", "lever5",
                                                           "lever5", "lever5", "lever5", "lever6", "lever6", "lever6", "lever6"
                          ), title = c("instinit", "instinit", "instinit", "instinit",
                                       "instinit", "instinit", "assessteach", "assessteach", "assessteach",
                                       "assessteach", "assessteach", "assessteach", "impteach", "impteach",
                                       "impteach", "impteach", "impteach", "impteach", "impteach", "infrastruct",
                                       "infrastruct", "infrastruct", "infrastruct", "infrastruct", "brengage",
                                       "brengage", "brengage", "brengage", "brengage", "brengage", "brengage",
                                       "teachrec", "teachrec", "teachrec", "teachrec", "teachrec", "teachrec",
                                       "instinit", "instinit", "instinit", "instinit", "instinit", "instinit",
                                       "assessteach", "assessteach", "assessteach", "assessteach", "impteach",
                                       "impteach", "impteach", "impteach", "impteach", "impteach", "infrastruct",
                                       "infrastruct", "infrastruct", "infrastruct", "infrastruct", "infrastruct",
                                       "brengage", "brengage", "brengage", "brengage", "brengage", "brengage",
                                       "teachrec", "teachrec", "teachrec", "teachrec", "teachrec", "instinit",
                                       "instinit", "instinit", "instinit", "instinit", "assessteach",
                                       "assessteach", "assessteach", "assessteach", "assessteach", "impteach",
                                       "impteach", "impteach", "impteach", "impteach", "impteach", "infrastruct",
                                       "infrastruct", "infrastruct", "infrastruct", "infrastruct", "brengage",
                                       "brengage", "brengage", "brengage", "brengage", "brengage", "teachrec",
                                       "teachrec", "teachrec", "teachrec"), question = c("q1", "q2",
                                                                                         "q3", "q4", "q5", "q6", "q1", "q2", "q3", "q4", "q5", "q6", "q1",
                                                                                         "q2", "q3", "q4", "q5", "q6", "q7", "q1", "q2", "q3", "q4", "q5",
                                                                                         "q1", "q2", "q3", "q4", "q5", "q6", "q7", "q1", "q2", "q3", "q4",
                                                                                         "q5", "q6", "q1", "q2", "q3", "q4", "q5", "q6", "q1", "q2", "q3",
                                                                                         "q4", "q1", "q2", "q3", "q4", "q5", "q6", "q1", "q2", "q3", "q4",
                                                                                         "q5", "q6", "q1", "q2", "q3", "q4", "q5", "q6", "q1", "q2", "q3",
                                                                                         "q4", "q5", "q1", "q2", "q3", "q4", "q5", "q1", "q2", "q3", "q4",
                                                                                         "q5", "q1", "q2", "q3", "q4", "q5", "q6", "q1", "q2", "q3", "q4",
                                                                                         "q5", "q1", "q2", "q3", "q4", "q5", "q6", "q1", "q2", "q3", "q4"
                                       ), prompt = c("teaching is considered a priority in the primary institutional strategic plan",
                                                     ...
                                                     "most instructors consider good teaching to be a priority", "institutional policies recognize effective teaching in evaluation of instructor job performance",
                                                     ...
                                                     "teaching is formally assessed in multiple ways", "course design is considered in the assessment of teaching",
                                                     ...
                                                     "collaborative approaches to teaching are valued", "teaching practices are discussed across the institution through a range of mechanisms",
                                                     ...
                                                     "there are institutional rewards for effective teaching", "teaching accomplishments, contributions, and/or awards are publicized and/or celebrated",
                                                     "teaching is valued in instructor hiring processes", "unit level administrators reward effective teaching as a priority",
                                                     ...
                                                     "senior administrators convey that effective teaching is an institutional priority",
                                                     "institution-wide initiatives promote innovative teaching practices",
                                                     "most instructors consider good teaching to be a priority", "staff who support teaching are regarded as an important resource for instructors and\neducational administrators",
                                                     "student evaluations of teaching are taken into consideration in hiring, promotion and tenure practices",
                                                     "teaching is formally assessed in multiple ways", "the results of teaching evaluations are accessible to students",
                                                     ...
                                                     "evidence of effective teaching is recognized in the evaluation of instructor job performance",
                                                     "there are institutional rewards for effective teaching", "teaching accomplishments, contributions, and/or awards are publicized and/or celebrated",
                                                     "teaching is valued in instructor hiring processes", "there is institutional recognition for staff who support teaching",
                                                     "teaching is considered a priority in the primary institutional strategic plan",
                                                     "effective teaching is clearly defined in institution-wide documents",
                                                     "senior administrators convey that effective teaching is an institutional priority",
                                                     "institution-wide initiatives promote innovative teaching practices",
                                                     "most instructors consider good teaching to be a priority", "students are invited to provide feedback to their instructors in addition to end of course evaluations",
                                                     "student evaluations of teaching are taken into consideration in hiring, promotion and tenure practices",
                                                     ...
                                                     "teaching assistants provide effective support for student learning",
                                                     "collaborative approaches to teaching are valued", "instructors discuss ways to improve the student learning experience with their colleagues",
                                                     "evidence of effective teaching is recognized in the evaluation of instructor job performance",
                                                     "there are institutional rewards for effective teaching", "teaching accomplishments, contributions, and/or awards are publicized and/or celebrated",
                                                     "teaching is valued in instructor hiring processes")), row.names = c(NA,
                                                                                                                          -101L), class = c("tbl_df", "tbl", "data.frame"))


#' TCPS ridgeline palette option #1 for use in tcps_lever_ridgeline
#' @export
pal_one <- c("#0051b3",
             "#a70076")

#' TCPS ridgeline palette option #2 for use in tcps_lever_ridgeline
#' @export
pal_two <- c("#98ce49",
             "#00298d")
